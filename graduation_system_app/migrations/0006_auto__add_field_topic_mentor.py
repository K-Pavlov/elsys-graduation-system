...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Topic.mentor'
        db.add_column(u'graduation_system_app_topic', 'mentor',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='mentors', on_delete=models.SET_NULL, default='', to=orm['graduation_system_app.Mentor'], blank=True, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Topic.mentor'
        db.delete_column(u'graduation_system_app_topic', 'mentor_id')
    ...
    models = {
        'graduation_system_app.mentor': {
            ...
            'id': ('django.db.models.fields.CharField', [], {'default': "'7264227109884531172'", 'max_length': '36', 'primary_key': 'True'}),
        ...
        'graduation_system_app.season': {
            ...
            'id': ('django.db.models.fields.CharField', [], {'default': "'7264355954608443876'", 'max_length': '36', 'primary_key': 'True'}),
        ...
        'graduation_system_app.student': {
            ...
            'id': ('django.db.models.fields.CharField', [], {'default': "'7264270059557491172'", 'max_length': '36', 'primary_key': 'True'}),
            'last_name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
        ...
        'graduation_system_app.topic': {
            ...
            'id': ('django.db.models.fields.CharField', [], {'default': "'7264355958903411172'", 'max_length': '36', 'primary_key': 'True'}),

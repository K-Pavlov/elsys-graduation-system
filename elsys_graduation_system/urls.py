...
urlpatterns = patterns('',
    ...
    url(r'^students/page/(?P<page_num>\d+)/$', students.get_page, name='get_student_page'),
    ...
    url(r'^topics/page/(?P<page_num>\d+)/$', topics.get_page, name='get_topic_page'),
    ...
    url(r'^seasons/page/(?P<page_num>\d+)/$', seasons.get_page, name='get_season_page'),
    ...
    url(r'^mentors/page/(?P<page_num>\d+)/$', mentors.get_page, name='get_mentor_page'),
    ...
    url(r'^referees/page/(?P<page_num>\d+)/$', referees.get_page, name='get_referee_page'),
    ...
    url(r'^referals/page/(?P<page_num>\d+)/$', referals.get_page, name='get_referal_page'),
    ...
    url(r'^class_letters/page/(?P<page_num>\d+)/$', class_letters.get_page, name='get_class_letter_page'),
    ...
    url(r'^specializations/page/(?P<page_num>\d+)/$', specializations.get_page, name='get_specialization_page'),
    ...
    url(r'^firms/page/(?P<page_num>\d+)/$', firms.get_page, name='get_firm_page'),
    ...
    url(r'^teachers/page/(?P<page_num>\d+)/$', teachers.get_page, name='get_teacher_page'),
    ...
    url(r'^comissions/page/(?P<page_num>\d+)/$', comissions.get_page, name='get_comission_page'),
